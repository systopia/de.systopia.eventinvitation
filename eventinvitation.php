 ...
 */
function eventinvitation_civicrm_xmlMenu(&$files)
{
    _eventinvitation_civix_civicrm_xmlMenu($files);
}
 ...
 */
function eventinvitation_civicrm_managed(&$entities)
{
    _eventinvitation_civix_civicrm_managed($entities);
}
 ...
 */
function eventinvitation_civicrm_caseTypes(&$caseTypes)
{
    _eventinvitation_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function eventinvitation_civicrm_angularModules(&$angularModules)
{
    _eventinvitation_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function eventinvitation_civicrm_alterSettingsFolders(&$metaDataFolders = null)
{
    _eventinvitation_civix_civicrm_alterSettingsFolders($metaDataFolders);
}
 ...
 *
function eventinvitation_civicrm_preProcess($formName, &$form) {
