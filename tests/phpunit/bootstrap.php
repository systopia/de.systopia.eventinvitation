...
// Make CRM_Eventinvitation_ExtensionUtil available.
require_once __DIR__ . '/../../eventinvitation.civix.php';
...
addExtensionToClassLoader($loader, 'de.systopia.eventinvitation');
 ...
 */
function _eventinvitation_test_civicrm_container(ContainerBuilder $container): void {
}
